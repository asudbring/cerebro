...
│   ├── cloudflare-worker/       # OAuth proxy (mcp.yourdomain.com) — DCR stub, path-specific RFC 9728 metadata, OAuth authorize/token proxy (strips resource, rewrites scope to GUID format for Entra), CORS allowlist, path traversal protection
